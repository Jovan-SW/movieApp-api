      ...
      >
        ...
        <div className="flex items-center gap-3 mb-3">
          <div className="flex items-center gap-1.5">
            <svg className="text-[var(--premium-color)] drop-shadow-[0_0_5px_rgba(212,175,112,0.5)]" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          {movie.director && (
            <div className="text-sm text-gray-300 border-l border-white/20 pl-3">
              Dir: <span className="text-white font-medium">{movie.director}</span>
            </div>
          )}
        </div>
        ...
        <button 
          className={`w-full py-2 mb-3 rounded-lg flex items-center justify-center gap-2 font-medium transition-colors text-sm
            ${isAddedToWatchlist 
